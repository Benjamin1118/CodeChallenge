...
# To understand how efficient the built-in Python sorting function is, you decided to implement 
# your own simple sorting algorithm and compare its speed to the speed of the Python sorting. 
