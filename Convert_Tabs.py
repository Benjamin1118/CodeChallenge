...
# You found an awesome customizable Python IDE that has almost everything 
# you'd like to see in your working environment. However, 
# after a couple days of coding you discover that there is one important 
# feature that this IDE lacks: it cannot convert tabs to spaces. Luckily, 
# the IDE is easily customizable, so you decide to write a plugin that would 
