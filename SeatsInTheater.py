...
# column or the columns to your left. To gain some courage, you decide to 
# calculate the number of such people and see if you can possibly make it to the exit 
